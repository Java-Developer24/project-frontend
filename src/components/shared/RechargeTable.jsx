      ...
      <table className="w-full text-center border-collapse">
        ...
        <tbody>
          {data.map((history, index) => (
            <tr key={history._id} className="h-12 border-b border-[#373737]">
              <td className="p-2 font-normal text-sm">
                {(currentPage - 1) * limit + index + 1}
              </td>
              <td className="p-2 font-normal text-sm">{history.transactionId}</td>
...
//                 </td>
//                 <td className="p-2 font-normal text-sm">
//                   {moment(history.date_time, "YYY/MM/DDThh:mm:ss A").format(
//                     "DD/MM/YYYY hh:mm:ss A"
//                   )}
//                 </td>
//                 <td className="p-2 font-normal text-sm text-teal-400">
